...
** 配置:
   SCHEDULED: <2014-04-19 六>
    评论配置使用 *Disqus*, 区要到 [[files://disqus.com/admin/signup/?utm_source%3DNew-Site][http:////disqus.com/admin/signup/?utm_source=new-site]] 注册，
...
* 2. 使用org-mode来写博客
** 什么是org-mode
org-mode 的哲学是organize your life in plaintext，是emacs中的一个模式，你可以用它做gtd 、todo、\\
project plan 、文学编程，类似wytwyg（所想即所得），可以将文章导出为html、pdf等文件，还可以与版本 \\
控制结合起来，在emacs下可以有很多hack的功能。\\
